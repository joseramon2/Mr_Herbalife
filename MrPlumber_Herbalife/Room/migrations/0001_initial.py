# Generated by Django 2.1 on 2018-11-08 01:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('id_accesorio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Room.Accesorios', verbose_name='AccesoriosACT a Actividades')),
            ],
        ),
        migrations.CreateModel(
            name='Actividades',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_actividades', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Room.Actividades', verbose_name='Realizadas a Reportes')),
            ],
        ),
        migrations.CreateModel(
            name='Codigos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=50, verbose_name='nombre')),
                ('descripcion', models.CharField(blank=True, max_length=50, verbose_name='descripcion')),
                ('codigo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Room.Codigos', verbose_name='Codigo a Codigos')),
            ],
        ),
        migrations.CreateModel(
            name='Pisos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_cuarto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Room.Cuartos')),
            ],
        ),
        migrations.AddField(
            model_name='cuartos',
        ...
        migrations.AddField(
            ...
            name='id_codigo',
            field=models.ForeignKey(on_delete=True, to='Room.Codigos', verbose_name='Accesorios a Codigo'),
        ),
        migrations.AddField(
            model_name='accesorios',
            name='id_cuarto',
